    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="d-flex gap-2 mt-3 flex-wrap">
                <a href="<?= BASE_URL ?>?url=adoption&id=<?= $chat['id'] ?>" class="btn" style="background-color: #e8722a; color: white;">Remplir le formulaire d'adoption</a>
                <a href="<?= BASE_URL ?>?url=favoris&action=ajouter&id_chat=<?= $chat['id'] ?>" class="btn" style="background-color: #e8722a; color: white;">Ajouter en favoris</a>
            </div>
</div>
