        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 mb-3">
                <div class="border p-3" style="background-color: #3a2a1a; color: #d4a96a; border-radius: 4px;">
                    <img src="<?= BASE_URL ?>/images/<?= $chat['image'] ?>" alt="<?= $chat['nom'] ?>" style="width:100%; height: 180px; object-fit: cover; border-radius: 4px;">
                    <p class="mt-2 mb-1"><strong><?= $chat['nom'] ?></strong></p>
